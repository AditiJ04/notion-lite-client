      ...
      <div className="max-w-4xl mx-auto px-8 pb-24">
        ...
        {loading ? (
          ...
          <div
            ...
            style={{ backgroundColor: "#FFFFFF", border: "1px dashed #E5E2DA" }}
          >
            <p
              style={{
                fontFamily: "Fraunces, serif",
            ...
            {documents.map((doc) => (
              <li key={doc.id}>
                <Link
                  ...
                  className="flex items-center justify-between rounded-xl px-5 py-4 transition-colors hover:bg-white group"
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 transition-opacity p-1.5 rounded-md hover:bg-[#FBEAE9] disabled:opacity-50"
                      style={{ color: "#B3261E" }}
                    >
                      {deletingId === doc.id ? (
                        <span
